...
% This is the basic test, with additionnal labels
% So far, no effects on PDF page labels

\title{Test talk with frame labels}
...
\begin{frame}[label=TextSlide1]{Text slide}
	\begin{itemize}
		\item Ein...
		\item Zwei.
		\item Drei !
...
\begin{frame}[label=GraphicSlide1]{Graphic slide}
...
\begin{frame}[label=TextSlide2]{Text slide 2}
	\begin{itemize}[<+->]
		\item Ein...
		\item Zwei.
		\item Drei !
...
\begin{frame}[label=GraphicSlide2]{Graphic slide 2}
	\begin{tikzpicture}[scale=2]
		\coordinate (O) at (0,0,0);
		\coordinate (A) at (0,\Width,0);
		\coordinate (B) at (0,\Width,\Height);
